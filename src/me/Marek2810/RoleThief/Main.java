...
public class Main extends JavaPlugin {
    ...
    public static ThiefedPlayerEvent thiefPlayerEvent;
    ...
    public void onEnable() {
        ...
        thiefPlayerEvent = new ThiefedPlayerEvent();
        ...
        //this.getServer().getPluginManager().registerEvents(thiefPlayerEvent, this);
    }
